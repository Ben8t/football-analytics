...
team_cluster_frequence <- data %>% 
	group_by(team_id, kmeans_cluster) %>% 
	summarise(count = n()) %>%
...
ggsave(filename="notebooks/pass2vec/img/team_cluster_frequence_heatmap.png", team_cluster_frequence_heatmap, width=18, height=10, dpi=300)
```
